...
export class Environment {
    ...
    // Typically, init() functions are added just after constructor():
    public async init() {
    ...
    public createCharacterButtons() {
        ...
        displayStatsContainer.isVisible = false; // The character pop-up image has the visible property set to false so that it's not showing initially
